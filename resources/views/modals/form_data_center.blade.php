    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <input type="text" name="nama_file" class="form-control" placeholder="ex: data sekolah blabla"
            autocomplete="off" required>
        </div>

        <div class="form-group">
          <label for="" class="form-label">Data Tahun *</label>
          <input type="text" name="tahun" class="form-control" placeholder="ex: 2020" autocomplete="off" maxlength="4"
            required>
        </div>
